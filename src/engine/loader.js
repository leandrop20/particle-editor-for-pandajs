...
game.Loader = game.Class.extend({
    ...
    **/
    ...
    initStage: function() {
        ...
        barBg.drawRect(0, 0, 100, 10);
        barBg.position.set(game.system.width / 2 - 50, game.system.height - 70);
        this.stage.addChild(barBg);

        this.bar = new game.Graphics();
        this.bar.beginFill(0xe6e7e8);
        this.bar.drawRect(0, 0, 100, 10);
        this.bar.position.set(game.system.width / 2 - 50, game.system.height - 70);
        ...
        if(game.Tween) {
            /*var tween = new game.Tween(this.symbol)
                ...
                // .easing(game.Tween.Easing.Elastic.In)
                .repeat()
                .yoyo();*/
            
            var tween = new game.Tween(this.symbol);
                tween.to({y:380}, (800)-this.percent);
                tween.easing(game.Tween.Easing.Cubic.In);
                tween.onComplete(function(){
                    tween2.start();
                });

            var tween2 = new game.Tween(this.symbol);
                tween2.to({y:(180+(this.percent*2))}, (600)-this.percent);
                tween2.easing(game.Tween.Easing.Cubic.Out);
